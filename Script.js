//Pseudocoe: Create a string called message to give the user a message.
...
// Pseudocoe: mainFullMessage = message + "-" + num1 + "-" + num2 + "-" +num3
// This will be the main message with all the varaibles combinded. 
const mainFullMessage = `${message} ${num1}-${num2}-${num3}`;

/* 
Pseudocoe: Create a dialog box that should say "You have received this message 
    because you have been chosen to open an 
    important vault. Here is the secret 
